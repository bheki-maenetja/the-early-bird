# Generated by Django 3.0.4 on 2020-04-01 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_url', models.CharField(max_length=1000)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favourite_publishers', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
